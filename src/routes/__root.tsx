  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-6">
      <div className="max-w-lg text-center">
        ...
        <h1 className="mt-4 font-display text-5xl leading-[1.05] text-balance text-foreground sm:text-6xl">
          We can't find that page.
        </h1>
        <p className="mt-5 text-muted-foreground">
          It may have moved, or the link might have a typo. Try one of
          these instead — they're the pages most people end up on.
        </p>
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-brass px-6 py-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-ink transition-colors hover:bg-brass-deep"
          >
            Home
          </Link>
          <Link
            to="/venues"
            className="inline-flex items-center justify-center rounded-full border border-white/15 px-6 py-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-foreground transition-colors hover:border-brass hover:text-brass"
          >
            Find a venue
          </Link>
          <Link

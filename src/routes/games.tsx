...
export const Route = createFileRoute("/games")({
  head: () => ({
    meta: [
      { title: `Gaming Floor — ${siteConfig.brand.name}` },
      {
        name: "description",
        content:
      ...
      {
        property: "og:title",
        content: `Gaming Floor — ${siteConfig.brand.name}`,
      },
      {
  ...
  return (
    <>
      <PageHero
        ...
        image={floorWideImg}
        imageAlt="A wide view of a Webbers Adult Gaming Centre — premium cabinets in warm low light."
      />
      ...
      <section className="border-b border-white/5 bg-surface/30">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-center text-sm text-muted-foreground">
            ...
            the people who build the cabinets you'll find in the best Adult
        ...
        <div className="mx-auto grid max-w-6xl items-start gap-12 lg:grid-cols-12">
          ...
          <div className="space-y-6 lg:col-span-8">
            <p className="font-display text-3xl leading-snug text-balance text-foreground sm:text-4xl">
              A good Adult Gaming Centre is curated, not crowded. We'd rather
              run a tight, beautifully-maintained floor than a wall of machines
              nobody plays.
            </p>
      ...
      <section className="px-6 py-[var(--section-y)] lg:px-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-6 font-display text-4xl leading-tight text-balance text-foreground sm:text-6xl">
            See them spinning on the floor.
          </h2>

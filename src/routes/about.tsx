...
import { HeritageTimeline } from "@/components/home";
...
function AboutPage() {
  ...
  return (
    <>
        ...
        <div className="mx-auto grid max-w-7xl items-start gap-16 lg:grid-cols-2">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 hidden rounded-2xl bg-brass p-7 text-ink shadow-2xl sm:block">
              <p className="font-display text-5xl font-bold leading-none">{yearsInFamily}</p>
          ...
          <div className="space-y-8">
            ...
            <h2 className="font-display text-4xl leading-tight text-balance text-foreground sm:text-5xl">
              It started with <span className="italic text-brass">{siteConfig.brand.founder}</span>{" "}
              in Rhyl.
            </h2>
            <div className="space-y-5 text-muted-foreground">
              ...
              <p>
                ...
                curated floors of cabinets from {siteConfig.partners.slice(0, -1).join(", ")} and{" "}
                {siteConfig.partners[siteConfig.partners.length - 1]}. We are a longstanding member
                of {siteConfig.compliance.tradeBody} and fully licensed by the{" "}
      ...
      {/* ============================================================
          TIMELINE — the heritage chronology (shared, scroll-animated)
          ============================================================ */}
      <HeritageTimeline
        eyebrow="The timeline"
        title="From the seafront to the high street."
        intro="Seven decades, one family. The major moments in the Webber story."
      />
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {generations.map((gen) => (
              ...
              >
                ...
                <p className="mt-6 text-sm leading-relaxed text-muted-foreground">{gen.body}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section className="px-6 py-[var(--section-y)] lg:px-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-muted-foreground">
            {siteConfig.brand.name} is licensed by the {siteConfig.compliance.regulator} and a
            longstanding member of {siteConfig.compliance.tradeBody}. Every venue operates a strict{" "}
            {siteConfig.compliance.idPolicy} ID policy, runs trained staff year-round, and is built
            around the safer gambling tools our guests rely on.
          </p>
      ...
      <section className="border-t border-white/5 bg-ink px-6 py-[var(--section-y)] lg:px-10">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="font-display text-4xl leading-tight text-balance text-foreground sm:text-5xl">
            Come and see an arcade for yourself.
          </h2>
          <p className="mx-auto mt-6 max-w-xl text-muted-foreground">
            Five arcades across Chester, North Wales and Greater Manchester — no booking, no
            pressure. We've kept a seat for you.
          </p>
          <div className="mt-10">
            <Link
              to="/venues"

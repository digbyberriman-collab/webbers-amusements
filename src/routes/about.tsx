...
const generations = [
  ...
  },
  {
    ...
    period: "2010s — now",
    body: "Modernised the estate into premium, fully-licensed Adult Gaming Centres. Five venues across Chester, North Wales and Greater Manchester, running to the same family standards.",
  },
];
